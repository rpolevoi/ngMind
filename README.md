...
2. The Tour of Heros example does too much, even though it is built sequentially. The best method for climbing the “wall of ice” that Angular 2 presents to newcomers must be to build concepts step-by-step, but __without the necessity of making some larger project hang together__.
...
[**Plunker Demo #1**](http://plnkr.co/edit/4A4juKPbXMrWzObNNal1?p=info target="_blank")
-- SIMPLEST POSSIBLE COMPONENT (NON-DYNAMIC) [**Github Repo**](https://github.com/rpolevoi/ngMind-beginner.mind_Demo1 target="_blank")
